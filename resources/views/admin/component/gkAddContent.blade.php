<div class="wrapper container">
    ...
    {!! Form::open(['url' => route('gkAdd'), 'class' => 'form-horizontal', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}

    <div class="form-group row align-items-center">
        {!! Form::label('name', 'Название:', ['class' => 'col-2 control-label']) !!}
        <div class="col-10">
            {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => 'Введите название гибкого камня']) !!}
        </div>
    </div>
    ...
    <div class="form-group row align-items-center">
        ...
        <div class="col-10">
            {!! Form::number('price', old('price'), ['class' => 'form-control', 'placeholder' => 'Введите цену гибкого камня']) !!}
        </div>
    </div>
