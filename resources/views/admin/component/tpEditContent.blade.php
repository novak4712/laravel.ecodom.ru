<div class="wrapper container">
    ...
    {!! Form::open(['url' => route('tpEdit', array('tp' => $data['id'])), 'class' => 'form-horizontal', 'method' => 'POST', 'enctype'=>'multipart/form-data' ]) !!}

    <div class="form-group row align-items-center">
        {!! Form::hidden('id', $data['id']) !!}
        {!! Form::label('name', 'Название:', ['class' => 'col-2 control-label']) !!}
        <div class="col-10">
            {!! Form::text('name',  $data['name'], ['class' => 'form-control', 'placeholder' => 'Введите название термопанели']) !!}
        </div>
    </div>
    ...
    <div class="form-group row align-items-center">
        ...
        <div class="col-10">
            {!! Form::number('price', $data['price'], ['class' => 'form-control', 'placeholder' => 'Введите цену термопанели']) !!}
        </div>
    </div>
