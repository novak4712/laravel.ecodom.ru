    ...
    <div class="smart-form">
        ...
        <form method="post" action="#" id="order">
            <div class="form-body">
                ...
                <div class="form-section">
                    <label for="comment" class="field-label">Введите № Гибкого камня</label>
                    <div class="prepend-icon">
                        <input type="number" value="0" min="1" name="label_gk" required>
                    </div>
                </div>
                <div class="form-section">
                    <label for="comment" class="field-label">Введите количество (в листах)</label>
                    <div class="prepend-icon">
                        <input type="number" value="0" min="1" name="count_gk" required>
                    </div>
                </div>
            </div>
